    ...
    <form id="submit" class="row flex-column px-5 py-4 py-md-5 col-12 col-md-9 col-lg-9 wrapper__border bg-white">
        ...
        <div class="row justify-content-between mb-4">
            <div class="col-12 col-md-6">
                <input class="input-box form-control mb-3" type="password" placeholder="Old Password" id="oldPassword" required>
                <input class="input-box form-control mb-3" type="password" placeholder="New Password" id="newPassword" required>
                <input class="input-box form-control mb-3" type="password" placeholder="Password Again" id="passwordAgain" required>
            </div>
